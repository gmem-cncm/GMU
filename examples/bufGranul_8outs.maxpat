...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 537.0, 56.0, 24.0 ],
					"text" : "3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 897.0, 335.0, 56.0, 24.0 ],
					"text" : "2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 609.0, 491.0, 56.0, 39.0 ],
					"text" : "1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 611.0, 35.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 551.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 568.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 510.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 527.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 469.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 486.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 445.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 989.0, 574.0, 109.0, 19.0 ],
					"text" : "prepend rand_minmax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 989.0, 551.0, 72.0, 19.0 ],
					"text" : "pack 0. 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.0, 551.0, 54.0, 22.0 ],
					"text" : "replace"
				}
...
,
					"patching_rect" : [ 706.5, 522.0, 21.0, 79.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 724.5, 496.0, 50.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 790.5, 496.0, 111.0, 19.0 ],
					"text" : "loadmess set snd-gran"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 609.0, 583.0, 87.0, 19.0 ],
					"text" : "buffer~ snd-gran"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 725.5, 522.0, 365.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 299.0, 393.0, 61.0, 19.0 ],
					"text" : "transp2sp~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 989.0, 473.0, 35.0, 19.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 989.0, 451.0, 70.0, 19.0 ],
					"text" : "speedlim 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 989.0, 430.0, 66.0, 19.0 ],
					"text" : "route voices"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 839.0, 322.0, 49.0, 22.0 ],
					"text" : "update"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 957.0, 336.0, 129.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 928.0, 392.0, 32.0, 19.0 ],
					"text" : "view"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 868.5, 392.0, 54.0, 19.0 ],
					"text" : "view_env"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.070588235294118, 0.643137254901961, 0.07843137254902, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 9.0,
					"id" : "obj-27",
					"maxclass" : "newobj",
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 839.0, 360.0, 137.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 497.0, 39.0, 19.0 ],
					"text" : "update"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 611.0, 175.0, 19.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage bufgran_sto @greedy 1",
					"varname" : "bufgran_sto"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 22.0, 526.0, 172.0, 74.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 583.0, 248.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 384.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 401.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 343.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 360.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 319.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 482.0, 16.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 278.0, 482.0, 18.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "pan", 0.14, 0.0, 0.25, 20.0, 1, "0./1." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "transp", 0.0, -12.0, 12.0, 20.0, 1, "semitone`" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "delay", 0.0, 0.0, 10000.0, 20.0, 1, "ms" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 490.0, 33.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 446.0, 946.0, 19.0 ],
					"text" : "bufGranul~ snd-gran env123 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 597.0, 534.0, 78.0, 20.0 ],
					"text" : "Load Sound"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 848.5, 356.0, 848.5, 356.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 966.5, 385.0, 981.0, 385.0, 981.0, 321.0, 966.5, 321.0 ],
					"source" : [ "obj-27", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 157.5, 519.0, 108.0, 519.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 377.125, 475.0, 390.0, 475.0 ],
					"source" : [ "obj-48", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 261.25, 475.0, 349.0, 475.0 ],
					"source" : [ "obj-48", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-36", 0 ],
					"midpoints" : [ 145.375, 475.0, 308.0, 475.0 ],
					"source" : [ "obj-48", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 29.5, 475.0, 267.0, 475.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-27::obj-229" : [ "live.tab", "live.tab", 0 ],
			"parameterbanks" : 			{
