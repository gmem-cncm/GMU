...
,
									"text" : "Open liveGranul~ help patcher",
									"varname" : "live.text[2]"
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-10::obj-1" : [ "number[58]", "number[43]", 0 ],
			"obj-10::obj-11" : [ "number[60]", "number[41]", 0 ],
			"obj-10::obj-13" : [ "live.text[2]", "live.text", 0 ],
			"obj-10::obj-2" : [ "number[63]", "number[39]", 0 ],
			"obj-10::obj-25" : [ "number[62]", "number[40]", 0 ],
			"obj-10::obj-28" : [ "number[61]", "number[42]", 0 ],
			"obj-10::obj-35" : [ "number[57]", "number[37]", 0 ],
			"obj-10::obj-36" : [ "number[59]", "number[38]", 0 ],
			"obj-10::obj-57::obj-6" : [ "dial", "dial", 0 ],
			"obj-10::obj-71" : [ "Binaural decoding[1]", "Binaural decoding", 0 ],
			"obj-10::obj-9" : [ "mc.live.gain~", "mc.live.gain~", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
