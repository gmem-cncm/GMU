...
long liveGranul_multichanneloutputs(t_liveGranul *x, long index)
{
	return x->x_nouts;
}
...
{
    t_class *c = class_new("mc.liveGranul~", (method)liveGranul_new, (method)liveGranul_free, sizeof(t_liveGranul), (method)NULL, A_GIMME, 0L);
    ...
    class_addmethod(c, (method)liveGranul_multichanneloutputs, "multichanneloutputs", A_CANT, 0); //mc Multichannel output
