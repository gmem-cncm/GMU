...
{ 
    ...
    c = class_new("mc.bufGranul~", (method)bufGranul_new, (method)bufGranul_free, sizeof(t_bufGranul), (method)NULL, A_GIMME, 0L);
	...
	class_addmethod(c, (method)bufgranul_multichanneloutputs, "multichanneloutputs", A_CANT, 0); 
